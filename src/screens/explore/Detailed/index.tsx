...
import { parseLocationSlug } from "@/src/utils/location-slug";
import { Loader2, MapPin } from "lucide-react";
import { notFound, useRouter } from "next/navigation";

const ExploreByCategoryOrLocation = ({ slug }: { slug: string }) => {
  ...
  const { data: events, isLoading } = useConvexQuery<Doc<"events">[]>(
    isCategory
...
export default ExploreByCategoryOrLocation;
